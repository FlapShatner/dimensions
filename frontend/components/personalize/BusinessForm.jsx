...
export default function BusinessForm({ setImageFile, currentImage }) {
  const {
    formState: { errors },
    watch,
    register,
    ...
    <div>
      ...
      <div className='flex justify-between gap-4'>
        <div className={cn('flex flex-col gap-4 py-4 ')}>
          ...
          <div onClick={handleDone} className='flex border border-border p-2 text-accent justify-center hover:border-accent'>
            Done
          </div>
        </div>
        <div className='w-1/2'>
